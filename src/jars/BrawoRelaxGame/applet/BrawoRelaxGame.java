...
public class BrawoRelaxGame extends PApplet {
...
public void display()
{
  ...
  stroke(sinecolor(1),sinecolor(0),sinecolor(.5f));
  fill(0);
...
public float sinecolor(float percent)
{
  float slime=(sin(radians((((time +(255*percent)) % 255)/255)*360)))*255;
  return slime;
}
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "BrawoRelaxGame" };
    if (passedArgs != null) {
