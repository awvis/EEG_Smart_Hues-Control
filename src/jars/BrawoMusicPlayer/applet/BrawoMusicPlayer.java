...
import rsb.protocol.operatingsystem.*; 
import rsb.util.*; 
import rsb.transport.inprocess.*; 
import rsb.patterns.*; 
import rsb.eventprocessing.*; 
import rsb.protocol.introspection.*; 
import tutorial.protobuf.*; 
import rsb.filter.*; 
import rsb.protocol.collections.*; 
import rsb.transport.spread.*; 
import spread.*; 
import rsb.config.*; 
...
public class BrawoMusicPlayer extends PApplet {
...
text("BraWo : Brain @ Work", 190, 170);
 ...
 // image(shuffle, 160, 105);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "BrawoMusicPlayer" };
    if (passedArgs != null) {
